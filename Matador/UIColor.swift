...
//
//  Created by Pavel Yevtukhov on 9/7/17.
...
extension UIColor {
    ...
    static var lightGreenGrad: UIColor{
        return UIColor(red: 72.0/255.0, green: 205.0/255.0, blue: 189.0/255.0, alpha: 1.0)
    }
    static var darkGreenGrad: UIColor{
        return UIColor(red: 35.0/255.0, green: 223.0/225.0, blue: 163.0/255.0, alpha: 1.0)
    }
}
